...
const contactData = [
	...
	{ type: 'mail', value: 'zwakadawid@gmail.com', href: "mailto:zwakadawid@gmail.com" },
	{ type: 'facebook', value: 'Dawid Żwaka', href: "https://www.facebook.com/dawid.zwaka/" },
];
...
const ContactMethods = () => {
	...
	contactData.forEach(({ type, value, href }) => {
		methods.push(<strong class="portal"><span>{type}</span></strong>);
		values.push(<a href={href} target="_blank" class="portal"><span>{value}</span></a>);
	});
